...
public class Agent {
    ...
    private String fechaInicioAudit;
	...
	public String getFechaInicioAudit() {
		return fechaInicioAudit;
	}

	public void setFechaInicioAudit(String fechaInicioAudit) {
		this.fechaInicioAudit = fechaInicioAudit;
	}
	...
	public String toString() {
        ...
        sb.append(", fechaInicioAudit='").append(fechaInicioAudit).append('\'');
